  ...
  onGetClients((querySnapshot) => {
    ...
    querySnapshot.forEach((doc) => {
      ...
      clientContainer.innerHTML += `
          ...
          <h2>Cliente</h2>
            <div class="d-flex justify-content-around  mb-3 container-info">
              <div>
              ...
              <div>
              <img src="https://cdn-icons-png.flaticon.com/512/3577/3577429.png" alt="Imagen de Cliente">
              </div>
            </div>
              <div class="d-flex justify-content-around">
              <button class='btn mb-3 btn-delete' data-id="${doc.id}">Delete</button>
              <button class='btn mb-3 btn-edit' data-id="${doc.id}">Editar</button>
              </div>
          </div>
      `;
    });
...
clientForm.addEventListener("submit", (e) => {
  ...
  if (!editStatus) {
    ...
    editStatus = false;
    clientForm["btn-client-save"].innerText = "Guardar";
  }
  clientForm.reset();
});
